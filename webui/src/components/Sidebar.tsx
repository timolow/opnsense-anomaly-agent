...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ip-profiles', label: 'IP Profiles', icon: <Globe size={14} /> },
      { id: 'flow-classification', label: 'Flow ML', icon: <Layers size={14} /> },
      { id: 'incident-timeline', label: 'Incidents', icon: <ShieldAlert size={14} /> },
      { id: 'behavioral-baselines', label: 'Baselines', icon: <BarChart3 size={14} /> },
    ],
  },
  {
    name: 'Threats',
