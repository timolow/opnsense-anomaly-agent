        ...
        try:
            ...
            for row in cur.fetchall():
                ...
                self._baselines[key] = TrafficBaseline(
                    ...
                    protocol_distribution=json.loads(row[7]) if isinstance(row[7], str) else (row[7] if row[7] else {}),
                    ...
                    hourly_distribution=json.loads(row[13]) if isinstance(row[13], str) else (row[13] if row[13] else []),
